...
// analyze-team-video edge function for steerwrestling.
//
...
const SYSTEM_PROMPT =
  "You are an expert steerwrestling coach reviewing a roster athlete's run for a coaching team. " +
        ...
        messages: [
          { role: "system", content: SYSTEM_PROMPT + " JSON schema: " + JSON.stringify(ANALYSIS_SCHEMA) },
          {
            ...
            content: [
              {
                type: "text",
                text: `Analyze this steerwrestling run${athlete_name ? ` by ${athlete_name}` : ""}.`,
              },
              ...images,
            ],
          },
